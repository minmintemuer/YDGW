    ...
    <div class="col-lg-12">
        <div class="table-responsive">
            <table class="table table-bordered table-hover tablesorter">
                ...
                <tr>
                    <td>鸡汤名称</td>
                    <td><?php echo ($data[0]['soft_text_title']); ?></td>
                </tr>
                <tr>
                    <td>鸡汤作者</td>
                    <td><?php echo ($data[0]['soft_text_admin']); ?></td>
                </tr>
                <tr>
                    <td>鸡汤最后更新时间</td>
                    <td><?php echo (date("Y-m-d H:i:s",$data[0]['soft_text_time'])); ?></td>
                </tr>
                <tr>
                    <td>鸡汤展示主图</td>
                    <td><img src="/company/YDGW/Public<?php echo ($data[0]['soft_text_img']); ?>" style="max-height: 200px"></td>
                </tr>
                <tr>
                    <td>展示状态</td>
...
<div class="row">
    <div class="col-lg-12">
        <h1>鸡汤详情 <small>以下是鸡汤详情</small></h1>
    </div>
</div><!-- /.row -->
<div class="row">
    <div class="col-lg-12">
        <?php echo ($data[0]['soft_text_content']); ?>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo U('Admin/Index/edit_jitang','','');?>/id/<?php echo ($data[0]['soft_text_id']); ?>" class="btn btn-default">修改</a>
        <button this-id="<?php echo ($data[0]['soft_text_id']); ?>" onclick="ask_delete(this)" class="btn btn-danger">删除</button>
        <?php if($data[0]['is_show'] == 1): ?><a href="<?php echo U('Admin/Public/xiajia','','');?>/table/tb_soft_text/pk/soft_text_id/id/<?php echo ($data[0]['soft_text_id']); ?>" class="btn btn-danger">隐藏</a>
            <?php else: ?>
            <a href="<?php echo U('Admin/Public/shangjia','','');?>/table/tb_soft_text/pk/soft_text_id/id/<?php echo ($data[0]['soft_text_id']); ?>" class="btn btn-default">展示</a><?php endif; ?>
    </div>
</div>
