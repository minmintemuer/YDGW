    ...
    <div class="col-lg-12">
        <div class="table-responsive">
            <table class="table table-bordered table-hover tablesorter">
                ...
                <tr>
                    <td>新闻名</td>
                    <td><?php echo ($data[0]['news_categroy']); ?></td>
                </tr>
                <tr>
                    <td>新闻作者</td>
                    <td><?php echo ($data[0]['news_admin']); ?></td>
                </tr>
                <tr>
                    <td>新闻最后更新时间</td>
                    <td><?php echo (date("Y-m-d H:i:s",$data[0]['news_time'])); ?></td>
                </tr>
                <tr>
                    <td>新闻展示主图</td>
                    <td><img src="/company/YD/Public<?php echo ($data[0]['news_img']); ?>" style="max-height: 200px"></td>
                </tr>
                <tr>
                    <td>用户点击次数</td>
                    <td><?php echo ($data[0]['news_hits']); ?></td>
                </tr>
                <tr>
                    <td>展示状态</td>
...
<div class="row">
    <div class="col-lg-12">
        <h1>新闻详情 <small>以下是新闻详情</small></h1>
    </div>
</div><!-- /.row -->
<div class="row">
    <div class="col-lg-12">
...
<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo U('Admin/Index/edit_news','','');?>/id/<?php echo ($data[0]['news_id']); ?>" class="btn btn-default">修改</a>
        <button this-id="<?php echo ($data[0]['news_id']); ?>" onclick="ask_delete(this)" class="btn btn-danger">删除</button>
        <?php if($data[0]['is_show'] == 1): ?><a href="<?php echo U('Admin/Public/xiajia','','');?>/table/tb_news/pk/news_id/id/<?php echo ($data[0]['news_id']); ?>" class="btn btn-danger">隐藏</a>
            <?php else: ?>
            <a href="<?php echo U('Admin/Public/shangjia','','');?>/table/tb_news/pk/news_id/id/<?php echo ($data[0]['news_id']); ?>" class="btn btn-default">展示</a><?php endif; ?>

    </div>
</div>
<script language="JavaScript">
    function ask_delete(e){
        if(confirm("是否要删除该条新闻？")){
            window.location.href="<?php echo U('Admin/Public/del','','');?>/table/tb_news/pk/news_id/id/"+$(e).attr("this-id");
