    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <?php if($_SESSION['login']['login_user']== 'SA'): ?><li><a href="<?php echo U('Admin/Index/user_','','html');?>"><i class="fa fa-dashboard"></i> 添加管理员</a></li>
            ...
            <ul class="nav navbar-nav navbar-right navbar-user">
                ...
                <li class="dropdown user-dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo ($_SESSION['login']['login_id']); ?> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <!--<li><a href="#"><i class="fa fa-user"></i> Profile</a></li>-->
                        <!--<li><a href="#"><i class="fa fa-envelope"></i> Inbox <span class="badge">7</span></a></li>-->
                        <li><a href="<?php echo U();?>"><i class="fa fa-gear"></i> 更改密码</a></li>
                        <li class="divider"></li>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label>课程名称</label>
            <input class="form-control" id="class_name" value="<?php echo ($data[0]['class_name']); ?>">
            <p class="help-block">请输入课程名称</p>
        </div>
        <div class="form-group">
            <label>任课教师</label>
            <input class="form-control" id="class_teacher" value="<?php echo ($data[0]['class_teacher']); ?>">
            <p class="help-block">请输入任课教师</p>
        </div>
        <div class="form-group">
            <label>课程价格</label>
            <input class="form-control" id="class_price" value="<?php echo ($data[0]['class_price']); ?>">
            ...
            <form id="image_form" action="<?php echo U('/Admin/Ajax/ajax_upload_image','','');?>" method="post" target="hidden_frame" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-3" style="display: block">
                        <img  id="image_area" src="/company/YDGW/Public<?php echo ($data[0]['class_img']); ?>" width="100%" height="auto" ihref="<?php echo ($data[0]['class_img']); ?>" >
                    </div>
                </div>
...
<script language="JavaScript">
    function tijiao(){
        if(confirm("是否提交？")){
            $.ajax({
                url:"<?php echo U('/Admin/Ajax/ajax_save_class','','html');?>",
                dataType: 'json',
                type:'post',
                data:{
