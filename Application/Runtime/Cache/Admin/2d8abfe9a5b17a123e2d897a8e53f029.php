    ...
    <div class="col-lg-12">
        <div class="table-responsive">
            <table class="table table-bordered table-hover tablesorter">
                ...
                <tr>
                    <td>简介上传者</td>
                    <td><?php echo ($data[0]['introduction_admin_id']); ?></td>
                </tr>
                <tr>
                    <td>简介最后更新时间</td>
                    <td><?php echo (date("Y-m-d H:i:s",$data[0]['introduction_time'])); ?></td>
                </tr>
                <tr>
                    <td>展示状态</td>
...
<div class="row">
    <div class="col-lg-12">
        <h1>简介详情 <small>以下是简介详情</small></h1>
    </div>
</div><!-- /.row -->
<div class="row">
    <div class="col-lg-12">
...
<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo U('Admin/Index/edit_jianjie','','');?>/id/<?php echo ($data[0]['introduction_id']); ?>" class="btn btn-default">修改</a>
        <button this-id="<?php echo ($data[0]['introduction_id']); ?>" onclick="ask_delete(this)" class="btn btn-danger">删除</button>
        <?php if($data[0]['is_show'] == 1): ?><a href="<?php echo U('Admin/Public/xiajianjie','','');?>/table/tb_introduction/pk/introduction_id/id/<?php echo ($data[0]['introduction_id']); ?>" class="btn btn-danger">隐藏</a>
            <?php else: ?>
            <a href="<?php echo U('Admin/Public/shangjiejian','','');?>/table/tb_introduction/pk/introduction_id/id/<?php echo ($data[0]['introduction_id']); ?>" class="btn btn-default">展示</a><?php endif; ?>
    </div>
</div>
