    ...
    <div class="col-lg-12">
        <div class="table-responsive">
            <table class="table table-bordered table-hover tablesorter">
                ...
                <tr>
                    <td>课程展示图片</td>
                    <td><img src="/company/YDGW/Public<?php echo ($data[0]['class_img']); ?>" style="max-height: 200px"></td>
                </tr>
                <tr>
                    <td>课程价格</td>
                    <td><?php echo ($data[0]['class_price']); ?></td>
                </tr>
                <tr>
                    <td>课程最后修改时间</td>
                    <td><?php echo (date("Y-m-d",$data[0]['class_time'])); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<div class="row">
    <div class="col-lg-12">
        <h1>课程详情 <small>以下是课程简介详情</small></h1>
    </div>
</div><!-- /.row -->
<div class="row">
    <div class="col-lg-12">
...
<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo U('Admin/Index/edit_pro','','');?>/id/<?php echo ($data[0]['class_id']); ?>" class="btn btn-default">修改</a>
        <button this-id="<?php echo ($data[0]['class_id']); ?>" onclick="ask_delete(this)" class="btn btn-danger">删除</button>
    </div>
</div>
