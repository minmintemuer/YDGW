...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label>新闻标题</label>
            <input class="form-control" id="news_categroy">
            <p class="help-block">请输入新闻名称</p>
        </div>
        <div class="form-group">
            <label>新闻作者</label>
            <input class="form-control" id="news_admin">
            <p class="help-block">请输入新闻作者</p>
        </div>
        <div class="form-group">
            <label>新闻摘要</label>
            <input class="form-control" id="news_introduction">
...
<script language="JavaScript">
    function tijiao(){
        if(confirm("是否提交？")){
            $.ajax({
                url:"<?php echo U('/Admin/Ajax/ajax_add_news','','html');?>",
                dataType: 'json',
                type:'post',
                data:{
                    news_categroy:$("#news_categroy").val(),
                    news_admin:$("#news_admin").val(),
