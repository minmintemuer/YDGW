        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover tablesorter">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p_d): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($p_d['teacher_name']); ?></td>
                        <td><?php echo ($p_d['teacher_class_name']); ?></td>
                        <td>
                            <a href="<?php echo U('Admin/Index/area_detail','','');?>/id/<?php echo ($p_d['teacher_id']); ?>" this-id="<?php echo ($p_d['teacher_id']); ?>" class="btn btn-primary">查看详情</a>
                            <button this-id="<?php echo ($p_d['teacher_id']); ?>" onclick="ask_delete(this)" class="btn btn-danger">删除</button>
                            <a href="<?php echo U('Admin/Index/edit_area','','');?>/id/<?php echo ($p_d['teacher_id']); ?>" class="btn btn-success">编辑</a>
                        </td>
