...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label>标题</label>
            <input class="form-control" id="img_title" value="<?php echo ($data[0]['img_title']); ?>">
            ...
            <form id="image_form" action="<?php echo U('/Admin/Ajax/ajax_upload_image','','');?>" method="post" target="hidden_frame" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-3" style="display: block">
                        <img  id="image_area" src="/company/YDGW/Public<?php echo ($data[0]['img_url']); ?>" width="100%" height="auto" ihref="<?php echo ($data[0]['img_url']); ?>" >
                    </div>
                </div>
...
<script language="JavaScript">
    function tijiao(){
        if(confirm("是否提交？")){
            $.ajax({
                url:"<?php echo U('/Admin/Ajax/ajax_save_img','','html');?>",
                dataType: 'json',
                type:'post',
                data:{
                    id:<?php echo ($data[0]['img_id']); ?>,
