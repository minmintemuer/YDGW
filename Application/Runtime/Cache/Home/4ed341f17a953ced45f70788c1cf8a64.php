	...
	<body>
		...
		<div class="section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 contenteditable="true">全部案例</h1></div>
				</div>
			</div>
		</div>
		<div class="section">
							...
							<div class="container">
								<div class="row">
									<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="col-md-3">
											<a class="a_color" href="<?php echo U('Home/Index/alxq','','');?>/id/<?php echo ($data['soft_text_id']); ?>">
												<img src="/YD/Public<?php echo ($data['soft_text_img']); ?>" class="img-responsive heght_max_197">
											</a>
											<a class="a_color" href="<?php echo U('Home/Index/alxq','','');?>/id/<?php echo ($data['soft_text_id']); ?>">
												<h2><?php echo ($data['soft_text_title']); ?></h2></a>
												<p><?php echo ($data['soft_text_introduction']); ?></p>
											<br>
