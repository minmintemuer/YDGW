		...
		<div id="fullcarousel-example" data-interval="false" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="item active">
					<img src="/YD/Public/20160523142613169.jpg" class="img-responsive height_max_400">
				</div>
			</div>
		</div>
	<!--课程列表-->
		<div class="section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 contenteditable="true">全部课程</h1></div>
				</div>
			</div>
		</div>
		<div class="section">
			<div class="container">
				<div class="row row_h">
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="col-md-3">
						<a href="<?php echo U('Home/Index/kcxq','','');?>/id/<?php echo ($data['class_id']); ?>" class="a_color">
							<img src="/YD/Public<?php echo ($data['class_img']); ?>" class="img-responsive height_max_197"></a>
						<a href="<?php echo U('Home/Index/kcxq','','');?>/id/<?php echo ($data['class_id']); ?>" class="a_color">
							<h2><?php echo ($data['class_name']); ?></h2>
						</a>
						<p><?php echo ($data['class_introduction']); ?></p>
                            <br>
