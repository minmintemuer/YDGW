	...
	<!--活动标题-->
			...
			<div class="container ">
				<div class="row ">
					<div class="col-md-12 ">
						...
						<h1><?php echo ($data[0]['activety_name']); ?></h1>
						<h5>
							<span>活动时间时间:&nbsp;	<?php echo (date('Y-m-d',$data[0]['activety_start_time'])); ?>&nbsp;&nbsp;到&nbsp;&nbsp;<?php echo (date('Y-m-d',$data[0]['activety_end_time'])); ?></span>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<span>面向人群：<?php echo ($data[0]['activety_crowd']); ?></span>
						</h5>
					</div>
				</div>
			</div>
		...
		<div class="section ">
			<div class="container ">
				<div class="row ">
					<div class="col-md-12 ">
						<p><?php echo ($data[0]['activety_content']); ?></p>
					</div>
				</div>
			</div>
		</div>
