			...
			<div class="carousel-inner">
						...
						<div class="row ">
							<div class="col-md-12 ">
								<ul class="breadcrumb" style="background-color: #fff;">
									...
									<li class="active">行业咨询详情</li>
								</ul>
								<h1><?php echo ($data[0]['news_categroy']); ?></h1>
								<h5><span>最后更新时间:<?php echo (date("Y-m-d H:i:s",$data[0]['news_time'])); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;<span>浏览：<?php echo ($data[0]['news_hits']); ?></span></h5>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="section ">
					<div class="container ">
						<div class="row ">
							<div class="col-md-12 ">
								<p><?php echo ($data[0]['news_content']); ?></p>
							</div>
						</div>
					</div>
				</div>
