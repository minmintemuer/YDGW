...
<!--公司活动大图-->
        ...
        <div class="section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 contenteditable="true">全部活动</h1></div>
				</div>
			</div>
		</div>
<!--活动列表-->
		<div class="section">
			<div class="container">
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="row">
						<div class="col-md-6">
							<a href="<?php echo U('Home/Index/hdxq','','');?>/id/<?php echo ($data['activety_id']); ?>">
								<img src="/YD/Public<?php echo ($data['activety_img']); ?>" class="img-responsive heght_max_300">
							</a>
						</div>
						<div class="col-md-6">
							<a href="<?php echo U('Home/Index/hdxq','','');?>/id/<?php echo ($data['activety_id']); ?>" class="a_color">
								<h1><?php echo ($data['activety_name']); ?></h1>
							</a>
							<small>面向人群：<?php echo ($data['activety_crowd']); ?></small>
							<p>
								<?php echo ($data['activety_introduction']); ?>
							</p>
							<br>
							<br>
						</div>
