			...
			<div class="carousel-inner">
						...
						<div class="row ">
							<div class="col-md-12 ">
								<ul class="breadcrumb" style="background-color: #fff;">
									...
									<li>
										<a href="<?php echo U('Home/Index/allb','','');?>">全部案例</a>
									</li>
									<li class="active">案例详情</li>
								</ul>
								<h1><?php echo ($data[0]['soft_text_title']); ?></h1>
								<h5><span>最后更新时间:&nbsp;&nbsp;<?php echo (date('Y-m-d H:i:s',$data[0]['soft_text_time'])); ?></span></h5>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="section ">
					<div class="container ">
						<div class="row ">
							<div class="col-md-12 ">
								<p><?php echo ($data[0]['soft_text_content']); ?></p>
							</div>
						</div>
					</div>
				</div>
