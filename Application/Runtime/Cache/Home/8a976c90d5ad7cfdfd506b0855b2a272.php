		...
		<div id="fullcarousel-example" data-interval="false" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="item active">
					<img src="/YD/Public/20160523145614717.jpg" class="heght_max_450">
				</div>
			</div>
		</div>
		<div class="section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 contenteditable="true">全部资讯</h1></div>
				</div>
			</div>
		</div>
	<!--资讯列表-->
							...
							<div class="container">
								<div class="row row_h">
									<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="col-md-3">
											<a class="a_color" href="<?php echo U('Home/Index/zxxq','','');?>/id/<?php echo ($data['news_id']); ?>">
												<img src="/YD/Public<?php echo ($data['news_img']); ?>" class="img-responsive heght_max_197">
											</a>
											<a class="a_color" href="<?php echo U('Home/Index/zxxq','','');?>/id/<?php echo ($data['news_id']); ?>">
												<h2><?php echo ($data['news_categroy']); ?></h2>
											</a>
                                                <p>
                                            <?php echo ($data['news_introduction']); ?>
                                                </p>
                                            <br>
